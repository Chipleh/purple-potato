...
(function($) {
    ...
    $(document).ready(function(){
        ...
        $('.sliding-box').click(function(){ function movetobox(item){ var offbox = $(item).offset().top; offbox = offbox - 60; $('body').animate({scrollTop:offbox}, 'slow');} setTimeout(movetobox(this),1000); });
