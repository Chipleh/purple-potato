<div id="page-wrapper"><div id="page" class="<?php print $classes ? 'with-secondary-menu': 'without-secondary-menu'; ?>">

  <div id="header" class="<?php print $secondary_menu; ?>"><div class="section clearfix">
      ...
      <div id="name-and-slogan"<?php print ($hide_site_name && $hide_site_slogan) ? ' class="element-invisible"' : ''; ?>>
        ...
        <?php if ($site_name): ?>
          ...
          <?php else: /* Use h1 when the content title is empty */ ?>
            <h1 id="site-name"<?php print ($hide_site_name) ? ' class="element-invisible"' : ''; ?>>
              <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><span><?php print $site_name; ?></span></a>
            </h1>
          <?php endif; ?>
        <?php endif; ?>
