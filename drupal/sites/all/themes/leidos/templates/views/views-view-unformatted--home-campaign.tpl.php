    ...
    <div class="heroCarousel__inner-full-width-center">
        ...
        <div class="heroCarousel__inner-full-width-right">
            ...
            <div class="heroCarousel__inner">
                ...
                <a class="cta cta__secondary" href="<?php print $slide->field_field_cta[0]['raw']['display_url']; ?>" onClick="<?php $gacode = $slide->field_field_ga_code[0]['raw']['value'];  print $gacode; ?>"><?php print $slide->field_field_cta[0]['raw']['title']; ?></a></div>
        </div>
        <?php endforeach; ?>
